...
const options = [
  { value: 10, label: "10 Dibs" },
  { value: 20, label: "20 Dibs" },
  { value: 30, label: "30 Dibs" },
  { value: 40, label: "40 Dibs" },
];
        ...
        <Fade left>
          <div className="col-xs-12 col-md-6">
            <div className="content-border card-height">
              ...
              <p>You Won: 0/39 Dibs</p>
              <p>0/39 Dibs was Added to Your Deposit!</p>
            </div>
          </div>
        </Fade>
        <Fade right>
