...
const options = [
  { value: 10, label: "10 pFTM" },
  { value: 20, label: "20 pFTM" },
  { value: 30, label: "30 pFTM" },
  { value: 40, label: "40 pFTM" },
];
          ...
          <div className="col-xs-12 col-md-6">
            <div className="content-border card-height">
              <div className="emp-img">
                <img src="./img/2pftm.png" className="emp" alt="emp" />
              </div>
              <p>Last Entry: Win/Lose</p>
              <p>You Won: 0/39 pFTM</p>
              <p>0/39 pFTM was Added to Your Deposit!</p>
            </div>
          </div>
        </Fade>
        <Fade right>
