...
const options = [
  { value: 10, label: "10 Tomb" },
  { value: 20, label: "20 Tomb" },
  { value: 30, label: "30 Tomb" },
  { value: 40, label: "40 Tomb" },
];
          ...
          <div className="col-xs-12 col-md-6">
            <div className="content-border card-height">
              <div className="emp-img">
                <img src="./img/2tomb.png" className="emp" alt="emp" />
              </div>
              <p>Last Entry: Win/Lose</p>
              <p>You Won: 0/39 Tomb</p>
              <p>0/39 Tomb was Added to Your Deposit!</p>
            </div>
          </div>
        </Fade>
        <Fade right>
          <div className="col-xs-12 col-md-6">
            <div className="content-border card-height">
              <div className="emp-img">
                <img src="./img/tomb.png" className="emp" alt="emp" />
              </div>
              <p>20 Tomb Entry Pool</p>
              <p>[Enter Raffle]</p>
              <p>(-20 Tomb from Your Deposit)</p>
            </div>
          </div>
        </Fade>
        <div className="col-xs-12 col-md-12">
