...
const options = [
  { value: 10, label: "10 2omb" },
  { value: 20, label: "20 2omb" },
  { value: 30, label: "30 2omb" },
  { value: 40, label: "40 2omb" },
];
        ...
        <Fade left>
          <div className="col-xs-12 col-md-6">
            <div className="content-border card-height">
              ...
              <p>You Won: 0/39 2omb</p>
              <p>0/39 2omb was Added to Your Deposit!</p>
            </div>
          </div>
        </Fade>
        <Fade right>
