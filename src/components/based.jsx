...
const options = [
  { value: 10, label: "10 Based" },
  { value: 20, label: "20 Based" },
  { value: 30, label: "30 Based" },
  { value: 40, label: "40 Based" },
];
        ...
        <Fade left>
          <div className="col-xs-12 col-md-6">
            <div className="content-border card-height">
              ...
              <p>0/39 Based was Added to Your Deposit!</p>
            </div>
          </div>
        </Fade>
        <Fade right>
          <div className="col-xs-12 col-md-6">
            <div className="content-border card-height">
              ...
              <p>[Enter Raffle]</p>
              <p>(-20 Based from Your Deposit)</p>
            </div>
          </div>
        </Fade>
        <div className="col-xs-12 col-md-12">
